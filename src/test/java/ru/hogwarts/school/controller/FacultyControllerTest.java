...
public class FacultyControllerTest {
    ...
    void getFacultyByColorPositiveTest() throws Exception {
        ...
        when(facultyRepository.findByColorLikeIgnoreCase(anyString())).thenReturn(list);
    ...
    void getFacultyByColorNegativeTest() throws Exception {
        when(facultyRepository.findByColorLikeIgnoreCase(anyString())).thenReturn(Collections.emptyList());
    ...
    void findFacultyByColorOrNameTest() throws Exception {
        ...
        when(facultyRepository.findFacultyByNameIgnoreCase(anyString()))
                .thenReturn(list);
